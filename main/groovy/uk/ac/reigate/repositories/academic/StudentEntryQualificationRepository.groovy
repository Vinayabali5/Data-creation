...
import uk.ac.reigate.domain.academic.StudentEntryQualificationPk


interface StudentEntryQualificationRepository extends CrudRepository<StudentEntryQualification, StudentEntryQualificationPk> {
