...
interface StudentRepository extends PagingAndSortingRepository<Student, Integer>, QueryDslPredicateExecutor {
    
    Student findById(Integer id)
    
    List<Student> findByTutorGroupId(Integer tutorGroupId)
