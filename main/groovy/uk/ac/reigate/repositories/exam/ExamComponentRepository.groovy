...
public interface ExamComponentRepository extends PagingAndSortingRepository<ExamComponent, Integer> {
    ...
    List<ExamComponent> findByTimetableDateAndTimetableSession(
            @Param(value = "timetableDateStart") @Temporal(TemporalType.DATE) Date timetableDateStart,
    @Param(value = "timetableSession") String timetableSession)
}
