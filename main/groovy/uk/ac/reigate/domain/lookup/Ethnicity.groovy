...
class Ethnicity extends ILREntity implements Serializable {
    ...
    Ethnicity(Integer id, String code, String description, String shortDescription, Date validFrom, Date validTo){
        this.id = id;
        this.code = code;
    ...
    Ethnicity(String code, String description, String shortDescription, Date validFrom, Date validTo){
