...
public class QEntryQualification extends EntityPathBase<EntryQualification> {
    ...
    public QEntryQualification(String variable) {
        this(EntryQualification.class, forVariable(variable), INITS);
    }

    public QEntryQualification(Path<? extends EntryQualification> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEntryQualification(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEntryQualification(PathMetadata metadata, PathInits inits) {
        this(EntryQualification.class, metadata, inits);
    }

    public QEntryQualification(Class<? extends EntryQualification> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this.type = inits.isInitialized("type") ? new QEntryQualificationType(forProperty("type")) : null;
    }
