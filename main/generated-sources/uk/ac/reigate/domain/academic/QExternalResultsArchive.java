...
public class QExternalResultsArchive extends EntityPathBase<ExternalResultsArchive> {
    ...
    public QExternalResultsArchive(String variable) {
        this(ExternalResultsArchive.class, forVariable(variable), INITS);
    }

    public QExternalResultsArchive(Path<? extends ExternalResultsArchive> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QExternalResultsArchive(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QExternalResultsArchive(PathMetadata metadata, PathInits inits) {
        this(ExternalResultsArchive.class, metadata, inits);
    }

    public QExternalResultsArchive(Class<? extends ExternalResultsArchive> type, PathMetadata metadata, PathInits inits) {
