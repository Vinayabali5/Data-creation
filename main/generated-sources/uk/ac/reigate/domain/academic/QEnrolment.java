...
public class QEnrolment extends EntityPathBase<Enrolment> {
    ...
    public QEnrolment(String variable) {
        this(Enrolment.class, forVariable(variable), INITS);
    }

    public QEnrolment(Path<? extends Enrolment> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEnrolment(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEnrolment(PathMetadata metadata, PathInits inits) {
        this(Enrolment.class, metadata, inits);
    }

    public QEnrolment(Class<? extends Enrolment> type, PathMetadata metadata, PathInits inits) {
