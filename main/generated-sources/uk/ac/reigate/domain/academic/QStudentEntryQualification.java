...
public class QStudentEntryQualification extends EntityPathBase<StudentEntryQualification> {
    ...
    public final uk.ac.reigate.domain.exam.QExamBoard examBoard;
    ...
    public QStudentEntryQualification(String variable) {
        this(StudentEntryQualification.class, forVariable(variable), INITS);
    }

    public QStudentEntryQualification(Path<? extends StudentEntryQualification> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentEntryQualification(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentEntryQualification(PathMetadata metadata, PathInits inits) {
        this(StudentEntryQualification.class, metadata, inits);
    }

    public QStudentEntryQualification(Class<? extends StudentEntryQualification> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this.examBoard = inits.isInitialized("examBoard") ? new uk.ac.reigate.domain.exam.QExamBoard(forProperty("examBoard")) : null;
