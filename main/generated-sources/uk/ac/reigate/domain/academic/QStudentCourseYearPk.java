...
public class QStudentCourseYearPk extends BeanPath<StudentCourseYearPk> {
    ...
    public QStudentCourseYearPk(String variable) {
        this(StudentCourseYearPk.class, forVariable(variable), INITS);
    }

    public QStudentCourseYearPk(Path<? extends StudentCourseYearPk> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentCourseYearPk(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentCourseYearPk(PathMetadata metadata, PathInits inits) {
        this(StudentCourseYearPk.class, metadata, inits);
    }

    public QStudentCourseYearPk(Class<? extends StudentCourseYearPk> type, PathMetadata metadata, PathInits inits) {
