...
public class QStudentYear extends EntityPathBase<StudentYear> {
    ...
    public QStudentYear(String variable) {
        this(StudentYear.class, forVariable(variable), INITS);
    }

    public QStudentYear(Path<? extends StudentYear> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentYear(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentYear(PathMetadata metadata, PathInits inits) {
        this(StudentYear.class, metadata, inits);
    }

    public QStudentYear(Class<? extends StudentYear> type, PathMetadata metadata, PathInits inits) {
