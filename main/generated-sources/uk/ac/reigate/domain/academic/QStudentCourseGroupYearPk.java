...
public class QStudentCourseGroupYearPk extends BeanPath<StudentCourseGroupYearPk> {
    ...
    public QStudentCourseGroupYearPk(String variable) {
        this(StudentCourseGroupYearPk.class, forVariable(variable), INITS);
    }

    public QStudentCourseGroupYearPk(Path<? extends StudentCourseGroupYearPk> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentCourseGroupYearPk(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentCourseGroupYearPk(PathMetadata metadata, PathInits inits) {
        this(StudentCourseGroupYearPk.class, metadata, inits);
    }

    public QStudentCourseGroupYearPk(Class<? extends StudentCourseGroupYearPk> type, PathMetadata metadata, PathInits inits) {
