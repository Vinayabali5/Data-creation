...
public class QCourseGroup extends EntityPathBase<CourseGroup> {
    ...
    public QCourseGroup(String variable) {
        this(CourseGroup.class, forVariable(variable), INITS);
    }

    public QCourseGroup(Path<? extends CourseGroup> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCourseGroup(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCourseGroup(PathMetadata metadata, PathInits inits) {
        this(CourseGroup.class, metadata, inits);
    }

    public QCourseGroup(Class<? extends CourseGroup> type, PathMetadata metadata, PathInits inits) {
