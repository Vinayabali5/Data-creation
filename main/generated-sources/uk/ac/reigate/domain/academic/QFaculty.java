...
public class QFaculty extends EntityPathBase<Faculty> {
    ...
    public QFaculty(String variable) {
        this(Faculty.class, forVariable(variable), INITS);
    }

    public QFaculty(Path<? extends Faculty> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QFaculty(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QFaculty(PathMetadata metadata, PathInits inits) {
        this(Faculty.class, metadata, inits);
    }

    public QFaculty(Class<? extends Faculty> type, PathMetadata metadata, PathInits inits) {
