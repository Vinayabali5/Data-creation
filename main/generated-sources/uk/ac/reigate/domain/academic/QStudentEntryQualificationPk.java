...
public class QStudentEntryQualificationPk extends BeanPath<StudentEntryQualificationPk> {
    ...
    public QStudentEntryQualificationPk(String variable) {
        super(StudentEntryQualificationPk.class, forVariable(variable));
    }

    public QStudentEntryQualificationPk(Path<? extends StudentEntryQualificationPk> path) {
        super(path.getType(), path.getMetadata());
    }

    public QStudentEntryQualificationPk(PathMetadata metadata) {
