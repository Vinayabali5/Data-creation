...
public class QGCSEScore extends EntityPathBase<GCSEScore> {
    ...
    public QGCSEScore(String variable) {
        this(GCSEScore.class, forVariable(variable), INITS);
    }

    public QGCSEScore(Path<? extends GCSEScore> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QGCSEScore(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QGCSEScore(PathMetadata metadata, PathInits inits) {
        this(GCSEScore.class, metadata, inits);
    }

    public QGCSEScore(Class<? extends GCSEScore> type, PathMetadata metadata, PathInits inits) {
