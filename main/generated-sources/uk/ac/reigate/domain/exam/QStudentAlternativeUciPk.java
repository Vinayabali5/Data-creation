...
public class QStudentAlternativeUciPk extends BeanPath<StudentAlternativeUciPk> {
    ...
    private static final long serialVersionUID = -213096162L;
    ...
    public QStudentAlternativeUciPk(String variable) {
        super(StudentAlternativeUciPk.class, forVariable(variable));
    }

    public QStudentAlternativeUciPk(Path<? extends StudentAlternativeUciPk> path) {
        super(path.getType(), path.getMetadata());
    }

    public QStudentAlternativeUciPk(PathMetadata metadata) {
