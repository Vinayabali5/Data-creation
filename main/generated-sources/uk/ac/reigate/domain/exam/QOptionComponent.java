...
public class QOptionComponent extends EntityPathBase<OptionComponent> {
    ...
    private static final long serialVersionUID = 1468005250L;
    ...
    public QOptionComponent(String variable) {
        this(OptionComponent.class, forVariable(variable), INITS);
    }

    public QOptionComponent(Path<? extends OptionComponent> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QOptionComponent(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QOptionComponent(PathMetadata metadata, PathInits inits) {
        this(OptionComponent.class, metadata, inits);
    }

    public QOptionComponent(Class<? extends OptionComponent> type, PathMetadata metadata, PathInits inits) {
