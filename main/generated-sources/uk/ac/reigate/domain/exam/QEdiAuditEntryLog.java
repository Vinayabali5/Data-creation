...
public class QEdiAuditEntryLog extends EntityPathBase<EdiAuditEntryLog> {
    ...
    private static final long serialVersionUID = -2100776279L;
    ...
    public QEdiAuditEntryLog(String variable) {
        this(EdiAuditEntryLog.class, forVariable(variable), INITS);
    }

    public QEdiAuditEntryLog(Path<? extends EdiAuditEntryLog> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEdiAuditEntryLog(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEdiAuditEntryLog(PathMetadata metadata, PathInits inits) {
        this(EdiAuditEntryLog.class, metadata, inits);
    }

    public QEdiAuditEntryLog(Class<? extends EdiAuditEntryLog> type, PathMetadata metadata, PathInits inits) {
