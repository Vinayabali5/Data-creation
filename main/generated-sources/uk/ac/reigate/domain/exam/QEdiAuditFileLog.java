...
public class QEdiAuditFileLog extends EntityPathBase<EdiAuditFileLog> {
    ...
    private static final long serialVersionUID = -1409436655L;
    ...
    public QEdiAuditFileLog(String variable) {
        this(EdiAuditFileLog.class, forVariable(variable), INITS);
    }

    public QEdiAuditFileLog(Path<? extends EdiAuditFileLog> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEdiAuditFileLog(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEdiAuditFileLog(PathMetadata metadata, PathInits inits) {
        this(EdiAuditFileLog.class, metadata, inits);
    }

    public QEdiAuditFileLog(Class<? extends EdiAuditFileLog> type, PathMetadata metadata, PathInits inits) {
