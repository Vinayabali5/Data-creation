...
public class QCourseSyllabus extends EntityPathBase<CourseSyllabus> {
    ...
    private static final long serialVersionUID = 1423711334L;
    ...
    public QCourseSyllabus(String variable) {
        this(CourseSyllabus.class, forVariable(variable), INITS);
    }

    public QCourseSyllabus(Path<? extends CourseSyllabus> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCourseSyllabus(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCourseSyllabus(PathMetadata metadata, PathInits inits) {
        this(CourseSyllabus.class, metadata, inits);
    }

    public QCourseSyllabus(Class<? extends CourseSyllabus> type, PathMetadata metadata, PathInits inits) {
