...
public class QExamSeatingPlan extends EntityPathBase<ExamSeatingPlan> {
    ...
    private static final long serialVersionUID = -12930463L;
    ...
    public QExamSeatingPlan(String variable) {
        this(ExamSeatingPlan.class, forVariable(variable), INITS);
    }

    public QExamSeatingPlan(Path<? extends ExamSeatingPlan> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QExamSeatingPlan(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QExamSeatingPlan(PathMetadata metadata, PathInits inits) {
        this(ExamSeatingPlan.class, metadata, inits);
    }

    public QExamSeatingPlan(Class<? extends ExamSeatingPlan> type, PathMetadata metadata, PathInits inits) {
