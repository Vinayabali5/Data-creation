...
public class QEdiStatusType extends EntityPathBase<EdiStatusType> {
    ...
    private static final long serialVersionUID = -457176176L;
    ...
    public QEdiStatusType(String variable) {
        super(EdiStatusType.class, forVariable(variable));
    }

    public QEdiStatusType(Path<? extends EdiStatusType> path) {
        super(path.getType(), path.getMetadata());
    }

    public QEdiStatusType(PathMetadata metadata) {
