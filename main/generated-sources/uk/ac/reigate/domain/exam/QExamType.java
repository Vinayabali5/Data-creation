...
public class QExamType extends EntityPathBase<ExamType> {
    ...
    private static final long serialVersionUID = -1180265025L;
    ...
    public QExamType(String variable) {
        super(ExamType.class, forVariable(variable));
    }

    public QExamType(Path<? extends ExamType> path) {
        super(path.getType(), path.getMetadata());
    }

    public QExamType(PathMetadata metadata) {
