...
public class QExamSeatPk extends BeanPath<ExamSeatPk> {
    ...
    private static final long serialVersionUID = -410852315L;
    ...
    public QExamSeatPk(String variable) {
        super(ExamSeatPk.class, forVariable(variable));
    }

    public QExamSeatPk(Path<? extends ExamSeatPk> path) {
        super(path.getType(), path.getMetadata());
    }

    public QExamSeatPk(PathMetadata metadata) {
