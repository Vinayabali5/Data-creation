...
public class QEdiAuditEntryLogPk extends BeanPath<EdiAuditEntryLogPk> {
    ...
    private static final long serialVersionUID = -211372412L;
    ...
    public QEdiAuditEntryLogPk(String variable) {
        super(EdiAuditEntryLogPk.class, forVariable(variable));
    }

    public QEdiAuditEntryLogPk(Path<? extends EdiAuditEntryLogPk> path) {
        super(path.getType(), path.getMetadata());
    }

    public QEdiAuditEntryLogPk(PathMetadata metadata) {
