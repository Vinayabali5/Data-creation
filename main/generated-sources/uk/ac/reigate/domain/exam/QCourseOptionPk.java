...
public class QCourseOptionPk extends BeanPath<CourseOptionPk> {
    ...
    private static final long serialVersionUID = -423471151L;
    ...
    public QCourseOptionPk(String variable) {
        super(CourseOptionPk.class, forVariable(variable));
    }

    public QCourseOptionPk(Path<? extends CourseOptionPk> path) {
        super(path.getType(), path.getMetadata());
    }

    public QCourseOptionPk(PathMetadata metadata) {
