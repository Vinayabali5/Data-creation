...
public class QExamSeat extends EntityPathBase<ExamSeat> {
    ...
    private static final long serialVersionUID = -1180314486L;
    ...
    public QExamSeat(String variable) {
        this(ExamSeat.class, forVariable(variable), INITS);
    }

    public QExamSeat(Path<? extends ExamSeat> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QExamSeat(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QExamSeat(PathMetadata metadata, PathInits inits) {
        this(ExamSeat.class, metadata, inits);
    }

    public QExamSeat(Class<? extends ExamSeat> type, PathMetadata metadata, PathInits inits) {
