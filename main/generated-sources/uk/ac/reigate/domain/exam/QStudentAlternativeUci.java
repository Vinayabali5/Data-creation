...
public class QStudentAlternativeUci extends EntityPathBase<StudentAlternativeUci> {
    ...
    private static final long serialVersionUID = 768492483L;
    ...
    public QStudentAlternativeUci(String variable) {
        this(StudentAlternativeUci.class, forVariable(variable), INITS);
    }

    public QStudentAlternativeUci(Path<? extends StudentAlternativeUci> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentAlternativeUci(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentAlternativeUci(PathMetadata metadata, PathInits inits) {
        this(StudentAlternativeUci.class, metadata, inits);
    }

    public QStudentAlternativeUci(Class<? extends StudentAlternativeUci> type, PathMetadata metadata, PathInits inits) {
