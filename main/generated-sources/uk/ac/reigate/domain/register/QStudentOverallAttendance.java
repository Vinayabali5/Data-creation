...
public class QStudentOverallAttendance extends EntityPathBase<StudentOverallAttendance> {
    ...
    public QStudentOverallAttendance(String variable) {
        this(StudentOverallAttendance.class, forVariable(variable), INITS);
    }

    public QStudentOverallAttendance(Path<? extends StudentOverallAttendance> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentOverallAttendance(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentOverallAttendance(PathMetadata metadata, PathInits inits) {
        this(StudentOverallAttendance.class, metadata, inits);
    }

    public QStudentOverallAttendance(Class<? extends StudentOverallAttendance> type, PathMetadata metadata, PathInits inits) {
