...
public class QRegisterMark extends EntityPathBase<RegisterMark> {
    ...
    public QRegisterMark(String variable) {
        this(RegisterMark.class, forVariable(variable), INITS);
    }

    public QRegisterMark(Path<? extends RegisterMark> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QRegisterMark(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QRegisterMark(PathMetadata metadata, PathInits inits) {
        this(RegisterMark.class, metadata, inits);
    }

    public QRegisterMark(Class<? extends RegisterMark> type, PathMetadata metadata, PathInits inits) {
