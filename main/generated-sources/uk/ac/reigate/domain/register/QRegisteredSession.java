...
public class QRegisteredSession extends EntityPathBase<RegisteredSession> {
    ...
    public QRegisteredSession(String variable) {
        this(RegisteredSession.class, forVariable(variable), INITS);
    }

    public QRegisteredSession(Path<? extends RegisteredSession> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QRegisteredSession(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QRegisteredSession(PathMetadata metadata, PathInits inits) {
        this(RegisteredSession.class, metadata, inits);
    }

    public QRegisteredSession(Class<? extends RegisteredSession> type, PathMetadata metadata, PathInits inits) {
