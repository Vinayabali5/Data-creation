...
public class QStudentConcessionType extends EntityPathBase<StudentConcessionType> {
    ...
    public QStudentConcessionType(String variable) {
        this(StudentConcessionType.class, forVariable(variable), INITS);
    }

    public QStudentConcessionType(Path<? extends StudentConcessionType> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentConcessionType(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentConcessionType(PathMetadata metadata, PathInits inits) {
        this(StudentConcessionType.class, metadata, inits);
    }

    public QStudentConcessionType(Class<? extends StudentConcessionType> type, PathMetadata metadata, PathInits inits) {
