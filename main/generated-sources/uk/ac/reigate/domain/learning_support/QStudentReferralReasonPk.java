...
public class QStudentReferralReasonPk extends BeanPath<StudentReferralReasonPk> {
    ...
    public QStudentReferralReasonPk(String variable) {
        super(StudentReferralReasonPk.class, forVariable(variable));
    }

    public QStudentReferralReasonPk(Path<? extends StudentReferralReasonPk> path) {
        super(path.getType(), path.getMetadata());
    }

    public QStudentReferralReasonPk(PathMetadata metadata) {
