...
public class QLearningSupportVisit extends EntityPathBase<LearningSupportVisit> {
    ...
    public QLearningSupportVisit(String variable) {
        this(LearningSupportVisit.class, forVariable(variable), INITS);
    }

    public QLearningSupportVisit(Path<? extends LearningSupportVisit> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QLearningSupportVisit(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QLearningSupportVisit(PathMetadata metadata, PathInits inits) {
        this(LearningSupportVisit.class, metadata, inits);
    }

    public QLearningSupportVisit(Class<? extends LearningSupportVisit> type, PathMetadata metadata, PathInits inits) {
