...
public class QInitialAssessmentLevel extends EntityPathBase<InitialAssessmentLevel> {
    ...
    public QInitialAssessmentLevel(String variable) {
        super(InitialAssessmentLevel.class, forVariable(variable));
    }

    public QInitialAssessmentLevel(Path<? extends InitialAssessmentLevel> path) {
        super(path.getType(), path.getMetadata());
    }

    public QInitialAssessmentLevel(PathMetadata metadata) {
