...
public class QLearningSupportCostCategory extends EntityPathBase<LearningSupportCostCategory> {
    ...
    public QLearningSupportCostCategory(String variable) {
        super(LearningSupportCostCategory.class, forVariable(variable));
    }

    public QLearningSupportCostCategory(Path<? extends LearningSupportCostCategory> path) {
        super(path.getType(), path.getMetadata());
    }

    public QLearningSupportCostCategory(PathMetadata metadata) {
