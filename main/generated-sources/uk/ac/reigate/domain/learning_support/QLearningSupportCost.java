...
public class QLearningSupportCost extends EntityPathBase<LearningSupportCost> {
    ...
    public QLearningSupportCost(String variable) {
        this(LearningSupportCost.class, forVariable(variable), INITS);
    }

    public QLearningSupportCost(Path<? extends LearningSupportCost> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QLearningSupportCost(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QLearningSupportCost(PathMetadata metadata, PathInits inits) {
        this(LearningSupportCost.class, metadata, inits);
    }

    public QLearningSupportCost(Class<? extends LearningSupportCost> type, PathMetadata metadata, PathInits inits) {
