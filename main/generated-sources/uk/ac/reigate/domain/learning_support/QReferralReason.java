...
public class QReferralReason extends EntityPathBase<ReferralReason> {
    ...
    public QReferralReason(String variable) {
        this(ReferralReason.class, forVariable(variable), INITS);
    }

    public QReferralReason(Path<? extends ReferralReason> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QReferralReason(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QReferralReason(PathMetadata metadata, PathInits inits) {
        this(ReferralReason.class, metadata, inits);
    }

    public QReferralReason(Class<? extends ReferralReason> type, PathMetadata metadata, PathInits inits) {
