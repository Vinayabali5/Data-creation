...
public class QStudentLearningSupport extends EntityPathBase<StudentLearningSupport> {
    ...
    public QStudentLearningSupport(String variable) {
        this(StudentLearningSupport.class, forVariable(variable), INITS);
    }

    public QStudentLearningSupport(Path<? extends StudentLearningSupport> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentLearningSupport(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentLearningSupport(PathMetadata metadata, PathInits inits) {
        this(StudentLearningSupport.class, metadata, inits);
    }

    public QStudentLearningSupport(Class<? extends StudentLearningSupport> type, PathMetadata metadata, PathInits inits) {
