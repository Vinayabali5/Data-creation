...
public class QStudentSpecialCategory extends EntityPathBase<StudentSpecialCategory> {
    ...
    public QStudentSpecialCategory(String variable) {
        this(StudentSpecialCategory.class, forVariable(variable), INITS);
    }

    public QStudentSpecialCategory(Path<? extends StudentSpecialCategory> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QStudentSpecialCategory(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QStudentSpecialCategory(PathMetadata metadata, PathInits inits) {
        this(StudentSpecialCategory.class, metadata, inits);
    }

    public QStudentSpecialCategory(Class<? extends StudentSpecialCategory> type, PathMetadata metadata, PathInits inits) {
