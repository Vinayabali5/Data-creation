...
public class QMasterRegister extends EntityPathBase<MasterRegister> {
    ...
    public QMasterRegister(String variable) {
        this(MasterRegister.class, forVariable(variable), INITS);
    }

    public QMasterRegister(Path<? extends MasterRegister> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QMasterRegister(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QMasterRegister(PathMetadata metadata, PathInits inits) {
        this(MasterRegister.class, metadata, inits);
    }

    public QMasterRegister(Class<? extends MasterRegister> type, PathMetadata metadata, PathInits inits) {
