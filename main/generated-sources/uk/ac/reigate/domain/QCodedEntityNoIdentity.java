...
public class QCodedEntityNoIdentity extends EntityPathBase<CodedEntityNoIdentity> {
    ...
    public QCodedEntityNoIdentity(String variable) {
        super(CodedEntityNoIdentity.class, forVariable(variable));
    }

    public QCodedEntityNoIdentity(Path<? extends CodedEntityNoIdentity> path) {
        super(path.getType(), path.getMetadata());
    }

    public QCodedEntityNoIdentity(PathMetadata metadata) {
