...
public class QCorrespondence extends EntityPathBase<Correspondence> {
    ...
    public QCorrespondence(String variable) {
        this(Correspondence.class, forVariable(variable), INITS);
    }

    public QCorrespondence(Path<? extends Correspondence> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCorrespondence(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCorrespondence(PathMetadata metadata, PathInits inits) {
        this(Correspondence.class, metadata, inits);
    }

    public QCorrespondence(Class<? extends Correspondence> type, PathMetadata metadata, PathInits inits) {
