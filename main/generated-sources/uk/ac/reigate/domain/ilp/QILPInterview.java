...
public class QILPInterview extends EntityPathBase<ILPInterview> {
    ...
    public final StringPath officeAction = createString("officeAction");
    ...
    public QILPInterview(String variable) {
        this(ILPInterview.class, forVariable(variable), INITS);
    }

    public QILPInterview(Path<? extends ILPInterview> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QILPInterview(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QILPInterview(PathMetadata metadata, PathInits inits) {
        this(ILPInterview.class, metadata, inits);
    }

    public QILPInterview(Class<? extends ILPInterview> type, PathMetadata metadata, PathInits inits) {
