...
public class QCorrespondenceType extends EntityPathBase<CorrespondenceType> {
    ...
    public QCorrespondenceType(String variable) {
        super(CorrespondenceType.class, forVariable(variable));
    }

    public QCorrespondenceType(Path<? extends CorrespondenceType> path) {
        super(path.getType(), path.getMetadata());
    }

    public QCorrespondenceType(PathMetadata metadata) {
