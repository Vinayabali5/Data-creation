...
public class QLetter extends EntityPathBase<Letter> {
    ...
    public final NumberPath<Integer> nonEntryWarning = createNumber("nonEntryWarning", Integer.class);

    public final NumberPath<Integer> pending = createNumber("pending", Integer.class);
