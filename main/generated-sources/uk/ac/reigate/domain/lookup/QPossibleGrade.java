...
public class QPossibleGrade extends EntityPathBase<PossibleGrade> {
    ...
    public QPossibleGrade(String variable) {
        this(PossibleGrade.class, forVariable(variable), INITS);
    }

    public QPossibleGrade(Path<? extends PossibleGrade> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QPossibleGrade(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QPossibleGrade(PathMetadata metadata, PathInits inits) {
        this(PossibleGrade.class, metadata, inits);
    }

    public QPossibleGrade(Class<? extends PossibleGrade> type, PathMetadata metadata, PathInits inits) {
