...
public class QStudentRemarkPermission extends EntityPathBase<StudentRemarkPermission> {
    ...
    public QStudentRemarkPermission(String variable) {
        super(StudentRemarkPermission.class, forVariable(variable));
    }

    public QStudentRemarkPermission(Path<? extends StudentRemarkPermission> path) {
        super(path.getType(), path.getMetadata());
    }

    public QStudentRemarkPermission(PathMetadata metadata) {
