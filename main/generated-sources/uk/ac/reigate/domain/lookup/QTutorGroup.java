...
public class QTutorGroup extends EntityPathBase<TutorGroup> {
    ...
    public QTutorGroup(String variable) {
        this(TutorGroup.class, forVariable(variable), INITS);
    }

    public QTutorGroup(Path<? extends TutorGroup> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QTutorGroup(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QTutorGroup(PathMetadata metadata, PathInits inits) {
        this(TutorGroup.class, metadata, inits);
    }

    public QTutorGroup(Class<? extends TutorGroup> type, PathMetadata metadata, PathInits inits) {
