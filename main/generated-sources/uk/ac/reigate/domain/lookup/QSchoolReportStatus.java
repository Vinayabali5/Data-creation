...
public class QSchoolReportStatus extends EntityPathBase<SchoolReportStatus> {
    ...
    public QSchoolReportStatus(String variable) {
        super(SchoolReportStatus.class, forVariable(variable));
    }

    public QSchoolReportStatus(Path<? extends SchoolReportStatus> path) {
        super(path.getType(), path.getMetadata());
    }

    public QSchoolReportStatus(PathMetadata metadata) {
