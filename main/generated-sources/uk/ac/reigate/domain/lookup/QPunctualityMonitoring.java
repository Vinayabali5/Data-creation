...
public class QPunctualityMonitoring extends EntityPathBase<PunctualityMonitoring> {
    ...
    public QPunctualityMonitoring(String variable) {
        super(PunctualityMonitoring.class, forVariable(variable));
    }

    public QPunctualityMonitoring(Path<? extends PunctualityMonitoring> path) {
        super(path.getType(), path.getMetadata());
    }

    public QPunctualityMonitoring(PathMetadata metadata) {
