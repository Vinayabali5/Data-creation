...
public class QAttendanceMonitoring extends EntityPathBase<AttendanceMonitoring> {
    ...
    public QAttendanceMonitoring(String variable) {
        super(AttendanceMonitoring.class, forVariable(variable));
    }

    public QAttendanceMonitoring(Path<? extends AttendanceMonitoring> path) {
        super(path.getType(), path.getMetadata());
    }

    public QAttendanceMonitoring(PathMetadata metadata) {
