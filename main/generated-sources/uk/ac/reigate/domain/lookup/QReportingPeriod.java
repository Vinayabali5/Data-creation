...
public class QReportingPeriod extends EntityPathBase<ReportingPeriod> {
    ...
    public QReportingPeriod(String variable) {
        this(ReportingPeriod.class, forVariable(variable), INITS);
    }

    public QReportingPeriod(Path<? extends ReportingPeriod> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QReportingPeriod(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QReportingPeriod(PathMetadata metadata, PathInits inits) {
        this(ReportingPeriod.class, metadata, inits);
    }

    public QReportingPeriod(Class<? extends ReportingPeriod> type, PathMetadata metadata, PathInits inits) {
