...
public class QWarningCodeChange extends EntityPathBase<WarningCodeChange> {
    ...
    public QWarningCodeChange(String variable) {
        this(WarningCodeChange.class, forVariable(variable), INITS);
    }

    public QWarningCodeChange(Path<? extends WarningCodeChange> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QWarningCodeChange(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QWarningCodeChange(PathMetadata metadata, PathInits inits) {
        this(WarningCodeChange.class, metadata, inits);
    }

    public QWarningCodeChange(Class<? extends WarningCodeChange> type, PathMetadata metadata, PathInits inits) {
