...
public class QBaseEntityNoIdentity extends EntityPathBase<BaseEntityNoIdentity> {
    ...
    public QBaseEntityNoIdentity(String variable) {
        super(BaseEntityNoIdentity.class, forVariable(variable));
    }

    public QBaseEntityNoIdentity(Path<? extends BaseEntityNoIdentity> path) {
        super(path.getType(), path.getMetadata());
    }

    public QBaseEntityNoIdentity(PathMetadata metadata) {
