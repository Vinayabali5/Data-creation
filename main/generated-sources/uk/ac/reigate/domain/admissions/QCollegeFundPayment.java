...
public class QCollegeFundPayment extends EntityPathBase<CollegeFundPayment> {
    ...
    public QCollegeFundPayment(String variable) {
        this(CollegeFundPayment.class, forVariable(variable), INITS);
    }

    public QCollegeFundPayment(Path<? extends CollegeFundPayment> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCollegeFundPayment(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCollegeFundPayment(PathMetadata metadata, PathInits inits) {
        this(CollegeFundPayment.class, metadata, inits);
    }

    public QCollegeFundPayment(Class<? extends CollegeFundPayment> type, PathMetadata metadata, PathInits inits) {
