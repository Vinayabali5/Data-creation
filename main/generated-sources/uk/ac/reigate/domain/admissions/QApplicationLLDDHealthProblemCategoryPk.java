...
/**
 * QApplicationLLDDHealthProblemCategoryPk is a Querydsl query type for ApplicationLLDDHealthProblemCategoryPk
 */
...
public class QApplicationLLDDHealthProblemCategoryPk extends BeanPath<ApplicationLLDDHealthProblemCategoryPk> {
    ...
    public QApplicationLLDDHealthProblemCategoryPk(String variable) {
        this(ApplicationLLDDHealthProblemCategoryPk.class, forVariable(variable), INITS);
    }

    public QApplicationLLDDHealthProblemCategoryPk(Path<? extends ApplicationLLDDHealthProblemCategoryPk> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QApplicationLLDDHealthProblemCategoryPk(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QApplicationLLDDHealthProblemCategoryPk(PathMetadata metadata, PathInits inits) {
        this(ApplicationLLDDHealthProblemCategoryPk.class, metadata, inits);
    }

    public QApplicationLLDDHealthProblemCategoryPk(Class<? extends ApplicationLLDDHealthProblemCategoryPk> type, PathMetadata metadata, PathInits inits) {
