...
public class AddressTest {
    ...
    void testConstructor_AllFieldsWithoutId() {
        ...
        String paon = 'dsd'
        String saon = 'tt'
        Address address = new Address(line1, line2, line3, line4, line5, town, county, postcode, buildingName, subBuilding, paon, saon)
        ...
        assertEquals(address.paon, paon)
        assertEquals(address.saon, saon)
    }
    ...
    void testConstructor_AllFieldsWithId() {
        ...
        Address address = new Address(id, line1, line2, line3, line4, line5, town, county, postcode, buildingName, subBuilding, paon, saon)
